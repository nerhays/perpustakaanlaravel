...
<div class="container">
    ...
    <form action="{{ route('jenisuser.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="id_jenis_user" value="{{ old('id_jenis_user') }}" required>
        </div>

        <div class="form-group">
            <label for="username">Jenis User</label>
            <input type="text" class="form-control" name="jenis_user" value="{{ old('jenis_user') }}" required>
        </div>
