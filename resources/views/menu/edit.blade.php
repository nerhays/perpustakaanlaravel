...
<div class="container">
    ...
    <form action="{{ route('managemenu.update', $menu->menu_id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="form-group">
            <label for="nama_user">Menu Id</label>
            <input type="text" class="form-control" name="menu_id" value="{{ old('menu_id', $menu->menu_id) }}" required>
        </div>

        <div class="form-group">
            <label for="username">Menu Name</label>
            <input type="text" class="form-control" name="menu_name" value="{{ old('menu_name', $menu->menu_name) }}" required>
        </div>
        <div class="form-group">
            <label for="username">Menu Link</label>
            <input type="text" class="form-control" name="menu_link" value="{{ old('menu_link', $menu->menu_link) }}" required>
        </div>
        <div class="form-group">
            <label for="username">Menu Icon</label>
            <div class="input-group">
                <input type="text" class="form-control" name="menu_icon" id="menu_icon" value="{{ old('menu_icon', $menu->menu_icon) }}" readonly required>
